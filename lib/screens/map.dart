...
class _ActivityMarkerMapState extends State<ActivityMarkerMap>
  ...
  void onGpsUpdate() {
    ...
    if (pos != null) {
      final color =
          widget.currentPosition.recent ? DesignColors.blueColor : Colors.grey;
          ...
          builder: (context, ms) {
            return Container(
              decoration: const BoxDecoration(
                  shape: BoxShape.circle, color: DesignColors.blueColor),
              child: Center(
                child: MapText(
...
class LocationMarker extends Marker {
  ...
  factory LocationMarker.fromLocation(LocationShortApi location,
    ...
    final color = focused ? DesignColors.redColor : Colors.black;
